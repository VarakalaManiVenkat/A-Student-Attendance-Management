...
--
-- Host: localhost
-- Generation Time: Dec 23, 2021 at 01:16 PM
...
--
-- Database: `a_student_attendance_management`
--
CREATE DATABASE IF NOT EXISTS `a_student_attendance_management` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `a_student_attendance_management`;
...
('dc25k42gmlt722z9irjqrmu8z8mxaasf', 'eyJ1c2VyaWQiOjEwfQ:1mxph7:K0t-Oq5hF2TYyhYMOPfDYG_fSP4fcrm_XDaHM3tDyPU', '2021-12-30 12:17:09.152748'),
...
('llsa6fs3evh35rkhr5no08pde62fmp6a', 'eyJ1c2VyaWQiOjh9:1mxnPo:G1pjcMU6yRMOdgolsHT4pQU9fJS-NMYj4KGkwZ3R--Y', '2021-12-30 09:51:08.643703'),
...
(8, 'Harish', 'Harish123@gmail.com', 'Harish', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(9, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(10, 'Rajesh', 'Rajesh123@gmail.com', 'Rajesh', '9535866270', 'India', 'Karnataka', 'Bangalore');
...
(76, 'Naive Bayes', '88.14814814814815'),
(77, 'SVM', '88.14814814814815'),
(78, 'Logistic Regression', '88.14814814814815'),
(79, 'KNeighborsClassifier', '88.14814814814815'),
(80, 'Decision Tree Classifier', '88.14814814814815');
...
(21, 'Not Satiesfied Attendance', '60.0'),
(22, 'Satiesfied Attendance', '40.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_student_attendance_results`
--

CREATE TABLE IF NOT EXISTS `remote_user_student_attendance_results` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ADay` varchar(300) NOT NULL,
  `Weekday` varchar(300) NOT NULL,
  `Student_Location` varchar(300) NOT NULL,
  `Location_Number` varchar(300) NOT NULL,
  `Country` varchar(300) NOT NULL,
  `Total_Student` varchar(300) NOT NULL,
  `Absence` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  `RNo` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=11 ;

--
-- Dumping data for table `remote_user_student_attendance_results`
--

INSERT INTO `remote_user_student_attendance_results` (`id`, `ADay`, `Weekday`, `Student_Location`, `Location_Number`, `Country`, `Total_Student`, `Absence`, `Prediction`, `RNo`) VALUES
(1, '24-08-2020', 'Monday', 'CONROE ISD', '170902', 'Montgomery', '63939', '1245', 'Satiesfied Attendance', 'R009'),
(2, '12-10-2020', 'Monday', 'CYPRESS-FAIRBANKS ISD', '101907', 'Harris', '114731', '8665', 'Not Satiesfied Attendance', 'R0078'),
(3, '13-10-2020', 'Tuesday', 'CYPRESS-FAIRBANKS ISD', '101907', 'Harris', '114779', '6450', 'Not Satiesfied Attendance', 'R0079'),
(4, '17-08-2020', 'Monday', 'FLOYDADA ISD', '77901', 'Floyd', '650', '0', 'Satiesfied Attendance', 'R0095'),
(5, '21-08-2020', 'Friday', 'FLOYDADA ISD', '77901', 'Floyd', '663', '14', 'Satiesfied Attendance', 'R0099'),
(6, '24-08-2020', 'Monday', 'FLOYDADA ISD', '77901', 'Floyd', '668', '28', 'Not Satiesfied Attendance', 'R00100'),
(7, '29-10-2020', 'Thursday', 'CONROE ISD', '170902', 'Montgomery', '64629', '2089', 'Not Satiesfied Attendance', 'R0051'),
(8, '24-08-2020', 'Monday', 'FLOYDADA ISD', '77901', 'Floyd', '668', '28', 'Not Satiesfied Attendance', 'R00100'),
(9, '30-10-2020', 'Friday', 'CONROE ISD', '170902', 'Montgomery', '64618', '2947', 'Not Satiesfied Attendance', 'R0052'),
(10, '29-09-2020', 'Tuesday', 'SNOOK ISD', '26903', 'Burleson', '484', '10', 'Satiesfied Attendance', 'R00243');
