"""a_student_attendance_management URL Configuration
...
from a_student_attendance_management import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Attendance_Type/$', remoteuser.Predict_Attendance_Type, name="Predict_Attendance_Type"),
    ...
    url(r'^View_Attendance_Type_Ratio/$', serviceprovider.View_Attendance_Type_Ratio, name="View_Attendance_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Attendance_Type/$', serviceprovider.View_Prediction_Of_Attendance_Type, name="View_Prediction_Of_Attendance_Type"),
