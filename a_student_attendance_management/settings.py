...
ROOT_URLCONF = 'a_student_attendance_management.urls'
...
WSGI_APPLICATION = 'a_student_attendance_management.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'a_student_attendance_management',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
